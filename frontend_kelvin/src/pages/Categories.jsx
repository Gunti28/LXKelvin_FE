...
const HomePage = () => {
  ...
  return (
    <div className="container-fluid ">
          ...
          <div className="carousel d-flex flex-column align-items-center">
            ...
            <div className="text-center p-4 text" style={{ background: 'transparent' }}>
              ...
              <Button
                ...
                className={`mt-2 ${Category.btn1} `}
                href="https://i.scdn.co/image/ab67616d0000b2734e42de9a9d9888d50b99e8a7"
              >
      ...
      <Thankyou show={modelType === "thankyou"} onClose={closeModel} />
