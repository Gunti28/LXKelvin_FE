...
const OrderSelectUpi = () => {
  ...
  return (
    <div className={SignupUpistyle.SelectContainer}>
      ...
      >
        <h4
          className={`${SignupUpistyle.heading} text-center mb-4 fw-semibold`}
        >
          Sign up UPI Pay
        </h4>
        ...
        <div className="d-flex justify-content-center align-items-center flex-column">
          ...
          <Card
            className={`w-50 ${SignupUpistyle.cardWrapper} ${
          ...
          {validated && !selectedApp && (
            <div className={`text-danger mt-1 ${SignupUpistyle.ErrorMessage}`}>
